...
$query = mysqli_query($conn, "SELECT * FROM tb_menu
    LEFT JOIN tb_kategori_menu ON tb_kategori_menu.id_kat_mn = tb_menu.kategori");
while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}

$select_kat_menu = mysqli_query($conn, "SELECT id_kat_mn,kategori_menu FROM tb_kategori_menu");
?>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/input_menu.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control py-3" id="uploadGambar" placeholder="Your Name" name="foto" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Harga" name="harga" required>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/delete_menu.php" method="POST">
                                ...
                                <div class="col-lg-12">
                                    Apakah anda ingin menghapus menu <?php echo $row['nama_menu'] ?>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
