...
session_start();
include "connect.php";
$kode_order = (isset($_POST['id_order'])) ? htmlentities($_POST['id_order']) : "";
...
if (!empty($_POST['input_item_validate'])) {
    $select = mysqli_query($conn, "SELECT * FROM tb_list_order WHERE menu = '$menu' && id_order = '$kode_order'");
