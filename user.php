                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/input_user.php" method="POST">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">Masukkan Nama.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">Masukkan Username.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">Pilih Level.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">Masukkan No Hp.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">Masukkan Password.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback">Masukkan Alamat.
                                    </div>
                                </div>
            ...
            ?>
                ...
                <div class="modal fade" id="ModalView<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Info Data User</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/input_user.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled name="level" aria-label="Default select example" required id="" class="form-select">
                                                    <?php
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/edit_user.php" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_bakul']) ? 'disabled' : ''; ?> type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" required value="<?php echo $row['username'] ?>">
                                                <label for="floatingInput">Username</label>
                                                <div class="invalid-feedback">Masukkan Username.
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select name="level" aria-label="Default select example" required id="" class="form-select">
                                                    <?php
                                                    $data = array("Admin/Owner", "Kasir", "Pelayan", "Dapur");
                                                    foreach ($data as $key => $value) {
                                                        if ($row['level'] == $key + 1) {
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" name="alamat" id="" style="height: 100px;" required><?php echo $row['alamat'] ?></textarea>
                                        <label for="floatingInput">Alamat</label>
                                        <div class="invalid-feedback">Masukkan Alamat.
                                        </div>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/delete_user.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_bakul']) {
                                            echo "<div class='alert alert-danger'>Tidak dapat menghapus user yang sedang digunakan</div>";
                                        } else {
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="delete_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_bakul']) ? 'hidden' : ''; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
